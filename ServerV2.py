        ...
        # message2="XX G 2 0 0"  # port instrument octave note velocity
            ...
            if(data[1]=='C'):
                ...
                if(int(data[3])==0):
                    ...
                    midion=[int(data[0]),int(chord_midi_Number[c.components()[0]+data[4]]),int(data[3])]
                    dummy_off=[int(data[0]),int(chord_midi_Number[c.components()[0]+data[4]]),0]
                    print(midion)
                    midiout.send_message(midion)
